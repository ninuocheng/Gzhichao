...
#lotus-miner sectors list --states Removed > $SectorsPeriodState
lotus-miner sectors list --states PreCommit1,PreCommit2,WaitSeed,Committing,CommitFinalize,CommitWait > $SectorsPeriodState
#lotus-miner sectors list --states PreCommit1 > $SectorsPeriodState
#lotus-miner sectors list --states PreCommit1 > $SectorsPeriodState
#扇区的详细信息
...
#let RequirePledgeMinHeight=3462516
